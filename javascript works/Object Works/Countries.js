...
for (let country of countries){
  ...
  //  console.log(`countryname:${CountryName} capital:${Capital} population:${Population} Currencies:${Currencies}`);
let countrydata={CountryName,Population,Capital,Currencies}
...
// let chinaCur=mycountries.find(data=>data.CountryName=="China").Currencies;
// console.log(chinaCur);

mycountries.filter(data=>data.Population>2000000).
map(country=>country.CountryName).forEach(name=>console.log(name));
